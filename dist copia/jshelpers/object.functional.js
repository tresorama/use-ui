...
export const updatePropsWith = manipulation => {
  return object => Object.assign({}, ...Object.keys(object).map(key => ({
    [key]: manipulation({ ...object[key]
    })
  })));
};
export const updatePropsWith2 = manipulation => {
  return object => Object.assign({}, ...Object.entries(object).map(([key, value]) => ({
...
export const updateSubObjectsOnlyWith = manipulation => {
  ...
  const manipulateOnlySubObject = propValue => isSubObject(propValue) ? manipulation(propValue) : propValue;
